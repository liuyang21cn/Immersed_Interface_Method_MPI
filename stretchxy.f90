...
CONTAINS
  ...
  FUNCTION xi2x(ksi) RESULT(x)
    ...
    x=TANH(cc*(ksi-0.5d0))/TANH(cc*0.5d0)/2.0d0+0.5d0
    x=ksi
  END FUNCTION xi2x
  ...
  FUNCTION x2xi(x) RESULT(ksi)
    ...
    ksi=0.5d0+atanh((2.0d0*x-1.0d0)*TANH(cc/2.0d0))/cc+0.5d0
    ksi=x
  END FUNCTION x2xi
  ...
  FUNCTION dxdxi(x)
    ...
    dxdxi=cc/2.0d0/TANH(cc/2.0d0)*(1.0d0-((x-0.5d0)*2.0d0*TANH(cc/2.0d0))**2.0d0)
    dxdxi=1.0d0
  END FUNCTION dxdxi
  ...
  FUNCTION d2xdxi2(x)
    ...
    d2xdxi2=-cc*cc*(2.0d0*x-1.0d0)*(1.0d0-((x-0.5d0)*2.0d0*TANH(cc/2.0d0))**2.0d0)
    d2xdxi2=0.0d0
  ...
  FUNCTION eta2y(ita) RESULT(y)
    ...
    y=TANH(cc*(ita-0.5d0))/TANH(cc*0.5d0)/2.0d0+0.5d0
    y=ita
  END FUNCTION eta2y
  ...
  FUNCTION y2eta(y) RESULT(ita)
    ...
    ita=0.5d0+atanh((2.0d0*y-1)*TANH(cc/2.0d0))/cc+0.5d0
    ita=y
  END FUNCTION y2eta
  ...
  FUNCTION dydeta(y)
    ...
    dydeta=cc/2.0d0/TANH(cc/2.0d0)*(1.0d0-((y-0.5d0)*2.0d0*TANH(cc/2.0d0))**2.0d0)
    dydeta=1.0d0
  END FUNCTION dydeta
  ...
  FUNCTION d2ydeta2(y)
    ...
    d2ydeta2=-cc*cc*(2.0d0*y-1.0d0)*(1.0d0-((y-0.5d0)*2.0d0*TANH(cc/2.0d0))**2.0d0)
    d2ydeta2=0.0d0
